  ...
  return (
    <div className="bg-gray-900 py-16" id="contact">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-red-500 mb-12">Contact Me</h2>
        
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="flex flex-col md:flex-row">
            {/* Información de contacto */}
            <div className="bg-gray-800 text-yellow-200 p-8 md:w-2/5">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a 
                    ...
                    className="bg-yellow-200 text-gray-800 p-2 rounded-full hover:bg-opacity-80 transition-all"
                  >
            ...
            <div className="bg-gray-800 text-yellow-200 p-8 md:w-3/5">
              ...
              <form action="https://formspree.io/f/mvondpkr" method="POST">
                <input
                  ...
                  className="w-full p-3 mb-4 bg-gray-700 text-yellow-200 rounded-md placeholder-yellow-200 focus:outline-none"
                  required
                />
                <input
                  type="email"
                ...
                <textarea
                  ...
                  required
                />
                <button type="submit" className="w-full py-3 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none transition-all">Send Message</button>
              </form>
            </div>
          </div>
        </div>
